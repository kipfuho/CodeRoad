...
/*
Bài 2.3. Viết chương trình yêu cầu nhập giá trị cho số nguyên x nhỏ hơn 100. In ra giá trị  a*x^2 + b*x + c  với a, b, c định sẵn.
*/


#include <stdio.h>

// Hàm get_value lấy giá trị a*x^2 + b*x + c
