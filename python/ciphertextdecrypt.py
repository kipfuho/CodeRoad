...
targetText = '32510ba9babebbbefd001547a810e67149caee11d945cd7fc81a05e9f85aac650e9052ba6a8cd8257bf14d13e6f0a803b54fde9e77472dbff89d71b57bddef121336cb85ccb8f3315f4b52e301d16e9f52f904'
...
def strxor(s1, s2):
    s = []
    for idx in range(0, min(len(s1), len(s2)), 2):
        b1 = hex_dict[s1[idx]] + hex_dict[s1[idx+1]]
        b2 = hex_dict[s2[idx]] + hex_dict[s2[idx+1]]
        byte = ''
    ...
    return binary_to_string(s)

for i in range(len(cipherTexts)):
    print(strxor(cipherTexts[i], targetText))
